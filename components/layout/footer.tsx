        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              <div className="w-10 h-10 rounded-lg bg-jirs-yellow flex items-center justify-center">
                <GraduationCap className="w-6 h-6 text-jirs-blue" />
              </div>
              <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              >
                <Mail className="w-4 h-4 text-jirs-yellow" />
                info@collegium.in
              </a>
              <a
                ...
                className="flex items-center gap-2 hover:text-white transition-colors"
              >
                <Phone className="w-4 h-4 text-jirs-yellow" />
                +91 800 123 4567
              </a>
              <div className="flex items-start gap-2">
                <MapPin className="w-4 h-4 text-jirs-yellow mt-0.5" />
        ...
        <div className="container py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-gray-400">
              © 2026 Collegium. All rights reserved. A JIRS Initiative.
            </p>
