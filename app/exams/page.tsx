...
export default function ExamsPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero */}
      <div className="bg-collegium-blue text-white py-12">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-collegium-blue/20 focus:border-collegium-blue"
              />
            </div>
