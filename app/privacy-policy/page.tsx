      ...
      <section className="py-12">
        <div className="container-custom max-w-4xl">
          <div className="bg-white rounded-xl border p-8 md:p-12 prose prose-lg max-w-none">
            <h2>Introduction</h2>
            <p>
              Welcome to Collegium (&quot;we,&quot; &quot;our,&quot; or
            ...
            <ul>
              <li>
                <strong>With Colleges:</strong> When you express interest in or
                apply to a college
              </li>
              <li>
            ...
            <p>
              ...
              information and improve our services. You can instruct your
            ...
            <ul>
              <li>Email: privacy@collegium.in</li>
              <li>
